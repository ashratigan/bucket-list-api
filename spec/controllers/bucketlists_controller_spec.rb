...
RSpec.describe BucketlistsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new bucketlist" do

        post :create, params: {bucketlist: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(bucketlist_url(Bucketlist.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new bucketlist" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the bucketlist" do
        bucketlist = Bucketlist.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the bucketlist" do
        bucketlist = Bucketlist.create! valid_attributes
